...
public class LoginScreen extends IdpAppScreen {
	...
	protected void init() {
		...
		getMainLayer().setBackgroundColor(StartTrackApp.ColorPallete.ELEMENT_BACK);
		...
		signInStyle.fontColor = StartTrackApp.ColorPallete.MAIN;
		...
		logo.setColor(StartTrackApp.ColorPallete.MAIN);
        ...
        emailWrapper.setUnderlineColor(StartTrackApp.ColorPallete.MAIN);
