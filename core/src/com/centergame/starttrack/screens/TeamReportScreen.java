...
import com.centergame.starttrack.graphics.starttrack_widgets.ParticipantWidget;
import com.centergame.starttrack.graphics.starttrack_widgets.TeamGradeWidget;
import com.centergame.starttrack.graphics.starttrack_widgets.base.FloatingIconButton;
...
public class TeamReportScreen extends StartTrackBaseScreen<Team> {
	...
	public TeamReportScreen(com.centergame.starttrack.api.model.Team team) {
    ...
    private HashSet<Integer> findEstimatedParticipants() {
        ...
        com.centergame.starttrack.api.model.Team t = StartTrackApp.getState().game.getTeamByID(report.team);
