...
public class TeamGradeWidget extends Widget<Report> {
	...
	public void init() {
		...
		if (StartTrackApp.getState().game.team_grade_required) {
			...
			com.centergame.starttrack.graphics.starttrack_widgets.base.RadioGroup rg = new com.centergame.starttrack.graphics.starttrack_widgets.base.RadioGroup(0, 3, data);
			rg.paddingLeft = sp / 2;
