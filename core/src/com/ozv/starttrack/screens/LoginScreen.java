...
public class LoginScreen extends IdpAppScreen {
	...
	private com.ozv.starttrack.graphics.starttrack_widgets.base.VLayout layout;
	...
	protected void init() {
		...
		float textFieldXpadding = com.ozv.starttrack.StartTrackApp.dp2px(24);
		float underlineExtention = com.ozv.starttrack.StartTrackApp.dp2px(12);
		float textFieldWidth = Gdx.graphics.getWidth() - textFieldXpadding * 2;

		float signInWidth = com.ozv.starttrack.StartTrackApp.dp2px(160);
		float signInHeight = com.ozv.starttrack.StartTrackApp.dp2px(36);
        float messageHeight = com.ozv.starttrack.StartTrackApp.dp2px(20);
		...
		message = new Text("", com.ozv.starttrack.StartTrackApp.getResources().getLabelStyle("label"));
        ...
        loader = new Loader(com.ozv.starttrack.StartTrackApp.getResources().getIcon("loader"));
